...
class HttpAPI {
    constructor(port, credentials = null) {
        ...
        app.use('/storage/img', express_1.default.static('public/podcasts/img'));
        app.use('/storage/audio', express_1.default.static('public/podcast_episodes/audio'));
        this.app = app;
        this.port = port;
    ...
    run() {
        if (this.credentials != null) {
            https_1.default.createServer(this.credentials, this.app).listen(this.port, () => {
